...
This is an assignment project. For questions or issues, contact:
...
- **Mem0 Team** - For the excellent memory management library
- **MCP Community** - For the Model Context Protocol SDK
- **Google** - For the Calendar API
- **OpenAI** - For GPT models
- **Streamlit** - For the frontend framework
- **Build Fast with AI** - For the learning opportunity
...
- Email: prathmesh@buildfastwithai.com, shubham@buildfastwithai.com

---

**Note:** This project demonstrates integration of modern AI tools and APIs for building practical applications. All external resources and libraries are properly cited.